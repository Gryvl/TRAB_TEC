...
public class Tela implements java.util.Observer{
	...
	*/
	...
	public void addAbaConsultas(){
        ...
        //pesquisa.setText("Pesquisa por nome do paciente",20);	
	...
	public void addAbaAtendentes(){
        ...
        pesquisaAtendente = new TextField("Pesquisa por nome de atendentes",20);
		...
		pesquisaAtendente.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
            	if(pesquisaAtendente.getText().equals("Pesquisa por nome de atendentes")){
            ...
            public void focusLost(FocusEvent e) {
            	if(pesquisaAtendente.getText().equals("")){
            		pesquisaAtendente.setForeground(Color.gray);
            		pesquisaAtendente.setText("Pesquisa por nome de atendentes");
            	}
            }
        });
		//caixaTipoPesquisa.addItem("Data");
        ...
        modeloAtendentes.setRowCount(0);
	...
	public void addAbaMedicos(){
        ...
        scrollMedicos = new JScrollPane(tabelaMedicos);
       	pesquisaMedico = new TextField("Pesquisa por nome de medicos",20);
		...
		pesquisaMedico.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
            	if	(pesquisaMedico.getText().equals("Pesquisa por nome de medicos")){
            ...
            public void focusLost(FocusEvent e) {
            	if	(pesquisaMedico.getText().equals("")){
            		pesquisaMedico.setForeground(Color.gray);
            		pesquisaMedico.setText("Pesquisa por nome de medicos");
            	}
            }
        });
		//caixaTipoPesquisa.addItem("Data");
